...
function NinjaSlider(a) {
    ...
    var d = "length",
        ...
        jb = function(e, c) {
            for (var b = [], a = 0; a < e[b]; a++) b[b[d]] = String[Y](e[N](a) - (c ? c : 3));
            return b.join("")
        },
        Ib = function(a) {
            return a.replace("", "www.abc.com")
        },
    ...
    eb.prototype = {
        ...
        addNavs: function() {
            ...
            var l = f[n][n].getElementsByTagName("*"),
                o = l[d];
            if (o) for (var g = 0; g < o; g++) if (v(l[g], "fs-icon")) {
                var h = l[g];
                break
            }
            if (h) {
                z(h, "click", function() {
                    ...
                    for (var c, g = 0; g < b[d]; g++) {
                        c = b[g];
                        if (c.nIs) if (c.nI.tagName == "IMG") c.nI.src = c.nIs[v(f, "fullscreen") ? 1 : 0];
    ...
    if (!a.initSliderByCallingInitFunc) if (P(a.b)) K();
    else Bb(K);
    return {

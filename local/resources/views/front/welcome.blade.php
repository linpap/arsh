...
@section('content')
    ...
    <img class="img-responsive center-block banner-ad2 m-t20" width="728" height="90" src="{{asset('img/advs/adv_'.$topHorizontalBanner)}}"  style="padding-top:10px;padding-bottom:10px" alt="banner_ad">
    @else
    ...
    <div class="container">
        ...
        <div class="carousel-indicators selector col-lg-4 col-md-12 col-sm-12" style="margin-top:15px">
            <div class="tabs center-block" style="width: 136px">
                <h3>সাম্প্রতিক <span>পোস্ট</span></h3>
            </div>
            ...
            <div class="titulos col-sm-12" style="text-align:left;padding:0">
                ...
                @if(count($slider_posts )>0)
                    @foreach($slider_posts as $key => $slide_title)
                        ...
                        <a href="{{url('posts/'.$slide_title->id)}}" data-target="#carousel-1" data-slide-to="{{$key}}" class="active" data-target="#carousel-1" data-slide-to="0"  style="text-decoration:none;font-size:15px;font-weight:bold;color:black;text-align:left">{{$slide_title->title}}</a>
                        </div>            
                    @endforeach
                @endif
                </p> 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0; margin-top:50px">
                ...
                <div class="tabs col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;padding:0">
                    <h2>সর্বশেষ <span>পোস্ট</span> <img style="margin:-5px 0 0 5px; " src="http://www.public-post.com/beta2/dist/icons/linez.png" /></h2>
                </div>
                <br clear="all">
                <!-- Project 1 -->
        ...
        <!-- Pagination -->
            ...
            <div class="row" style="height:400px">
                ...
                <div class="tabs" style="margin-bottom:10px">
                    <h2>সাম্প্রতিক <span>ফটো</span> <img style="margin:-5px 0 0 5px; " src="http://www.public-post.com/beta2/dist/icons/linez.png" /></h2>
                </div>
                </div>
        <!--SLIDER-->
    ...
    <div class="col-lg-12" style="">
        ...
        <div class="contenedor_post col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0"></div> 
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    @else
                        <div class="center-block banner-ad" style="padding-bottom:10px;padding-top:10px;padding-bottom:10px">
                ...
                @if(count($lastest_videos) > 0)
                    ...
                    @if($key == 0)
                        <?php 
                            ...
                            if($video->user()->first()->facebook_id == null && $video->user()->first()->twitter_id == null){
